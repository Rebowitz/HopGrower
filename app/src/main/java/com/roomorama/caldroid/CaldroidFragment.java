...
public class CaldroidFragment extends DialogFragment {
    ...
    protected boolean squareTextViewCell = false;
            ...
            dateItemClickListener = new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    if (caldroidListener != null) {
                        ...
                        caldroidListener.onSelectDate(parent, date, view);
                    }
                }
            };
        }
            ...
            dateItemLongClickListener = new OnItemLongClickListener() {
                ...
                public boolean onItemLongClick(AdapterView<?> parent,
                    ...
                    if (caldroidListener != null) {
                        ...
                        Date date = CalendarHelper
                                .convertDateTimeToDate(dateTime);
                        caldroidListener.onLongClickDate(date, view, position, id);
                    }
    ...
    public Void onViewCreated() {
        ...
        Log.d("HopGrower", "Entered onViewCreated");
    ...
    public void setSchedList(List<Scheduler> schedList) {

        schedulerList = schedList;
